...
- [x] **Préservation backend** : Fix .rstrip() sur entités spaCy pour conserver retours ligne/indentation ✅
- [x] **Test extension browser** : Vérifier conservation formatage dans champs de formulaire (textarea, inputs) ✅
- [x] **Test multi-ligne** : Valider avec texte complexe (code, listes, tableaux) depuis l'extension ✅
- [x] **Fix contenteditable** : Conversion \n → <br> pour champs HTML ✅
...
- [x] **Export multi-format** : Garde le format original ✅
...
- [x] **Patterns Regex RH** : Matricules, salaires, évaluations, plannings ✅ **NOUVEAU**
  - [x] Pattern matricules employés (EMP12345, MAT-0001, etc.) ✅
  - [x] Pattern salaires (3500€ brut, 2800 EUR net, etc.) ✅
  - [x] Pattern évaluations (Note: A+, Performance: 4/5, etc.) ✅
  - [x] Pattern plannings (09h-17h, Shift: Matin, etc.) ✅
  - [x] Intégration dans fast_anonymizer.py ✅
  - [x] Ajout checkboxes dans extension ✅
...
### ⚡ Performance
- [x] **Cache intelligent** : Redis/mémoire pour résultats d'anonymisation ✅ **NOUVEAU**
  - [x] Service Redis 7 avec volume persistant ✅
  - [x] Fallback in-memory si Redis indisponible ✅
  - [x] CacheManager avec TTL configurable ✅
  - [x] SessionManager pour mappings persistants ✅
  - [x] Endpoint `/deanonymize` pour restauration ✅
  - [x] Endpoints `/session/{id}/mappings` et `/session/{id}` DELETE ✅
  - [x] Contexte conversationnel (garde mappings entre requêtes) ✅
  - [x] **Extension : SessionManager JS** ✅
  - [x] **Extension : ResponseInterceptor avec MutationObserver** ✅
  - [x] **Extension : Bouton manuel 🔓 dé-anonymisation** ✅
  - [x] **Extension : Auto-deanonymize des réponses ChatGPT/Claude** ✅
  - [x] **Extension : Indicateurs visuels (badge ✓, bordure verte)** ✅
  - [x] **Extension : Sauvegarde préférences après F5/Ctrl+R** ✅ **RÉSOLU** (chrome.storage.sync + localStorage backup)
  - [x] **Extension : Export/Import backup des préférences** ✅ **NOUVEAU** (boutons dans popup)
  - [x] **Extension : Auto-backup localStorage à chaque changement** ✅ **NOUVEAU**
  - [x] **Extension : Horodatage "Dernière sauvegarde"** ✅ **NOUVEAU**
